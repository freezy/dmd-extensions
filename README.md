...
| `--zedmd-rgborder`             | [zedmd]<br>rgborder                            | Change any ZeDMD RGB order between 0 and 15.                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `--zedmd-wifi-address`         | [zedmd]<br>wifi.address                        | Connect to ZeDMD (HD) WiFi using this IP address.                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `--zedmd-wifi-port`            | [zedmd]<br>wifi.port                           | Connect to ZeDMD (HD) WiFi using this port. Default: 3333.                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `--zedmd-wifi-ssid`            | [zedmd]<br>wifi.ssid                           | Configure ZeDMD (HD) WiFi to use this SSID.                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `--zedmd-wifi-password`        | [zedmd]<br>wifi.password                       | Configure ZeDMD (HD) WiFi to use this password.                                                                                                                                                                                                                                                                                                                                                                                                                                |
