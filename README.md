...
| `--scaler-mode`                | [global]<br>scalermode                         | Scaler mode for standard content (vpm frames). Can have two scaling modes:<ul>  <li>'doubler' - Doubles all pixels</li>  <li>'scale2x' - Using Scale2x algorithm for smooth 2x scaling.</li>                                                                                                                                                                                                                                                                                                                                                                                                                                |
