...
namespace FFmpeg.AutoGen
{
    public unsafe static partial class ffmpeg
    {
        ...
        [DllImport(libpostproc, EntryPoint = "postproc_configuration", CallingConvention = CallingConvention.Cdecl)]
        public static extern string postproc_configuration();
        
        [DllImport(libpostproc, EntryPoint = "postproc_license", CallingConvention = CallingConvention.Cdecl)]
        public static extern string postproc_license();
        
        [DllImport(libpostproc, EntryPoint = "pp_postprocess", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(libpostproc, EntryPoint = "pp_get_mode_by_name_and_quality", CallingConvention = CallingConvention.Cdecl)]
        public static extern void* pp_get_mode_by_name_and_quality([MarshalAs(UnmanagedType.LPStr)] string @name, int @quality);
        
        [DllImport(libpostproc, EntryPoint = "pp_free_mode", CallingConvention = CallingConvention.Cdecl)]
        public static extern void pp_free_mode(void* @mode);
        
        [DllImport(libpostproc, EntryPoint = "pp_get_context", CallingConvention = CallingConvention.Cdecl)]
        public static extern void* pp_get_context(int @width, int @height, int @flags);
        
        [DllImport(libpostproc, EntryPoint = "pp_free_context", CallingConvention = CallingConvention.Cdecl)]
