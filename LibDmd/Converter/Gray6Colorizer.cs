...
namespace LibDmd.Converter
{
	...
	/// </remarks>
	public class Gray6Colorizer : AbstractSource, IConverter, IColoredGray2Source, IColoredGray4Source, IColoredGray6Source
	{
		public override string Name { get; } = "6-Bit Colorizer 64 colors";
		public FrameFormat From { get; } = FrameFormat.Gray6;
		...
		public Gray6Colorizer(Coloring coloring, AnimationSet animations)
		{
			_coloring = coloring;
		...
		public void Convert(DMDFrame frame)
		{
			...
			var planes = FrameUtil.Split(Dimensions.Value.Width, Dimensions.Value.Height, 6, frame.Data);
