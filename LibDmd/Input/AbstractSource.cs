...
namespace LibDmd.Input
{
	public abstract class AbstractSource
	{
		...
		protected void SetDebugPrivilege()
		{
			...
			// Get debug privilege in our token.  Allow this to fail silently, as
			// we might be able to exercise the rights this privilege would have
			...
			// point if it fails.
			SetPrivilege(hProcToken, "SeDebugPrivilege", true);
			CloseHandle(hProcToken);
		}

		bool SetPrivilege(IntPtr hToken, string privilege, bool enable)
		{
