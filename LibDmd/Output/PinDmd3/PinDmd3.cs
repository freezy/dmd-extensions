...
namespace LibDmd.Output.PinDmd3
{
	...
	public class PinDmd3 : IGray2Destination, IGray4Destination, IColoredGrayDestination, IColoredGray2Destination, IColoredGray4Destination, IRawOutput, IFixedSizeDestination
	{
