...
namespace LibDmd.DmdDevice
{
	...
	public class VirtualDmdConfig : AbstractConfiguration, IVirtualDmdConfig
	{
		...
		public void SetOptions(double brightness, double dotSize, double dotGlow, double backGlow, string glass, System.Windows.Thickness glassPadding, Color glassColor, string frame, System.Windows.Thickness framePadding, bool onlyForGame)
		{
			DoWrite = false;
