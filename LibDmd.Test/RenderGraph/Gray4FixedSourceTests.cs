...
namespace LibDmd.Test
{
	...
	public class Gray4FixedSourceTests : TestBase
	{
		...
		[TestCase]
		public async Task Should_Passthrough_Gray4_Frame()
		{
		...
		[TestCase]
		public async Task Should_Passthrough_Gray4_Frame_Flipped_Horizontally()
		{
			var dest = new DestinationFixedGray4(8, 4);
		...
		[TestCase]
		public async Task Should_Passthrough_Gray4_Frame_Flipped_Vertically()
		{
			var dest = new DestinationFixedGray4(8, 4);
		...
		[TestCase]
		public async Task Should_Passthrough_Gray4_Frame_Flipped()
		{
			var dest = new DestinationFixedGray4(8, 4);
		...
		[TestCase]
		public async Task Should_Convert_To_Gray4_Frame_With_Centering_Destination_NoHdScaling()
		{
		...
		[TestCase]
		public async Task Should_Convert_To_Gray4_Frame_With_Centering_Graph_NoHdScaling()
		{
		...
		[TestCase]
		public async Task Should_Convert_To_Gray4_Frame_With_Centering_Dest_Too_Small()
		{
		...
		[TestCase]
		public async Task Should_Convert_To_Gray4_Frame_With_Centering_Same_Width()
		{
			var dest = new DestinationFixedGray4(16, 8) { DmdAllowHdScaling = true };
